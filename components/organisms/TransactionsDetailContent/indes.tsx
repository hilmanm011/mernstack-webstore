...
const TransactionsDetailContent = (props: TransactionsDetailContentProps) => {
    const { data } = props
                    ...
                    <div className="main-content main-content-card overflow-auto">
                        <section className="checkout mx-auto">
                                ...
                                <div className="game-checkout d-flex flex-row align-items-center">
                                    <div className="pe-4">
                                        <div className="cropped">
                                            <Image loader={myLoader} src={data.historyVoucherTopup.thumbnail} width={200} height={130}
                                                className="img-fluid" alt="image thumb"/>
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div className="d-md-block d-flex flex-column w-100">
                                ...
                                href="https://wa.me/6289684130569?text=Halo%20Barangnya%20Masih%20Ada"
                                role="button"
                                >
                                    WhatsApp ke Admin
                                </a>
